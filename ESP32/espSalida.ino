...
void callback(char* topic, byte* message, unsigned int length)
{
  ...
  //primer output (topic: esp2/o1)
  if (String(topic) == "esp2/o1"){
...
while (!client.connected())
{
  ...
  if (client.connect("ESP32Client"))
  {
    ...
    client.subscribe("esp2/o1"); //esp32/output1'********* 
    client.subscribe("esp2/o2"); //********Topic: 'esp32/output2'*********   }
  }
  else{
...
{ 
  ...
  client.publish("esp2/boton",btnString);
  }
  }
